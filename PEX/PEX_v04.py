import sys
from PySide6.QtWidgets import QApplication, QWidget, QGridLayout, QLineEdit, QPushButton, QVBoxLayout, QLabel, \
...
class InputDialog(QWidget):
    ...
    def initUI(self):
        ...
        titleLabel.setStyleSheet(
            "font-size: 18px; font-weight: bold; font-family: 'Microsoft YaHei', sans-serif;")  # 设置样式


        # 添加下拉选框
        self.comboBox = QComboBox(self)
        self.comboBox.addItem('请选择金属层次')
        self.comboBox.addItems(['2', '3', '4', '5', '6'])
        self.comboBox.setCurrentIndex(0)
        self.comboBox.currentIndexChanged.connect(self.updateM)
        self.comboBox.setStyleSheet("""
            ...
            QComboBox::down-arrow {
                image: url(/path/to/your/icon.png);  /* Add path to your down arrow icon if you have one */
            }
        ...
        layout.addWidget(self.comboBox)  # 5. 添加下拉选框到布局
        ...
        submitButton = QPushButton('Confirm', self)
    ...
    # 根据M值选择不同的因素和数据
    def updateM(self):
        self.M = int(self.comboBox.currentText())  # 6. 更新 M 值
    ...
    def generate_excel(self):
        ...
        valid_two_layers_poly_combinations = [
            (Poly_W, Poly_S), (Poly_W, Poly_S_2x), (Poly_W, Poly_S_3x), (Poly_W_2x, Poly_S), (Poly_W_3x, Poly_S),
            (Max_W, Poly_S)
        ]
